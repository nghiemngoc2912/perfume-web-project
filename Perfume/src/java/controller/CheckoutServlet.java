...
//        processRequest(request, response);
        ...
        if (((List) session.getAttribute("cart")).isEmpty()) {
...
//        processRequest(request, response);
        ...
        odao.insertOrder(id, c.getId(), address);
        ...
        for (CartDetail cartDetail : cart) {
            od.insertOrderDetail(id, cartDetail.getPerfume().getId(), cartDetail.getQuantity());
        }
