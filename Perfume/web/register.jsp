                                        ...
                                        <div class="container" id="container">
                                            <div class="form-container sign-in">
                                                <form action="register" method="post">
                                                    <h1 style="font-size: 150%">Create Account</h1>
                                                    ...
                                                    <div class="form-outline mb-4">
                                                        <input type="text" class="form-control" name="cusname" required placeholder="Name" id="cusname">
                                                    </div>
                                                    <div class="form-outline mb-4">
                                                        <input type="text" class="form-control" name="phone" required placeholder="Phone" id="phone">
                                                    </div>
                                                    <div class="form-outline mb-4">
                                                        <input type="text" class="form-control" name="email" required placeholder="Email" id="email">
                                                    </div>
